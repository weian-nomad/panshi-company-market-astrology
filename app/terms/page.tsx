    ...
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            <h2>免費版、廣告與盤勢 Pro</h2>
            <p>免費版可持續使用公司盤、基本解讀、今日五盤、日期問盤與觀察簿，不要求先訂閱。免費版可能在完成一段研究後顯示廣告；較長的獎勵式影片由你自行選擇是否觀看，不觀看也不影響基本功能。</p>
            <p>盤勢 Pro 提供完整歷史案例、較完整的分布與研究工作區，並移除廣告。這些功能增加的是資料檢視深度，不會提供個股評級、未來價格方向或交易指令。</p>
            <p>符合資格的新訂閱者可使用七天免費試用。試用或付費期結束後，App 會回到免費版。訂閱由 Apple 自動續訂與收費；可在 Apple 帳號設定中管理或取消，退款依 Apple 與適用法令辦理。購買前顯示的 App Store 價格與條件為準。</p>
          </section>
