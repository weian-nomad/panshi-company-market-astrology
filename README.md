...
免費版是完整可用的主產品：公司盤、基本解讀、今日五盤、日期問盤摘要與觀察簿都能持續使用，營運上以廣告支持。較長的獎勵式影片由使用者自願觀看，可暫時展開一份完整歷史檔案。

盤勢 Pro 提供完整歷史案例、分布與不中斷的研究工作流，並移除廣告。符合資格的新訂閱者可試用 7 天；取消或到期後直接回到免費版，不刪除本機觀察簿。完整方案與廣告節奏見 [docs/business-model.md](docs/business-model.md)。
