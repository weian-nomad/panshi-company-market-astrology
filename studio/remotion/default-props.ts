...
const samples = [
  ...
  ["2382", "廣達", "電腦及週邊設備業", "rare-sample", "稀有組態", 298.5, -0.3, 3, 2, null, null, null, [2.1, -1.4, 0.7]],
] as const;
...
const introNarration = "我是 AI 虛擬觀測員墨衡。今日五盤，五檔股票，五種入選理由。價格採未還原收盤價。";
